<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BinDelete.aspx.cs" Inherits="Plugins_JHWMS_BinManager_BinDelete" %>
                ...
                <ext:GridPanel ID="gridMain" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server"      DataIndex="MATER_NO"         Text="物料号"         Width="100" />
                            <ext:Column runat="server"      DataIndex="MATER_NAME"         Text="物料名称"         Width="200" />
                            ...
                            <ext:CommandColumn runat="server" Width="80" Text="操作" Align="Center">
                                <Commands>
