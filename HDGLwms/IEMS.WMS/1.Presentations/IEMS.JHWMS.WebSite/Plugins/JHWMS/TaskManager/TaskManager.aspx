<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TaskManager.aspx.cs" Inherits="Plugins_JHWMS_TaskManager_TaskManager" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="<%= Page.ResolveUrl("./") %>TriggerFieldSearchPalletDatas.js?id=<%=DateTime.Now.ToString("yyyyMMddHHmmss") %>"></script>
    <!--gridMain数据展示-->
    <script type="text/javascript">
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         var saveAddWindows = function () {
             var palletNo = App.txtAddPallet.getValue();
            ...
            App.direct.RequestTaskCmd(palletNo, sLocPlcNo, {
                success: function (result) {
                    if (result == "") {
                ...
                <ext:GridPanel ID="gridMain" runat="server" Region="Center">
                    ...
                    <ColumnModel ID="columnModel" runat="server">
                        <Columns>
                            ...
                            <ext:Column runat="server"      DataIndex="OBJID"           Text="指令ID"           Width="80" />
                                ...
                                <ext:Container runat="server" Layout="HBoxLayout" Padding="5">
                                    <Items>
                                        <ext:FieldContainer runat="server" FieldLabel="工装编号" Layout="HBox" LabelAlign="Right" Flex="1">
                                            <Items>
                                                <ext:TriggerField ID="txtAddPalletName" runat="server" Flex="1" Editable="false">
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Search" />
                                                    </Triggers>
                                                    <Listeners>
                                                        <TriggerClick Fn="TriggerFieldSearchPalletDatas" />
                                                    </Listeners>
                                                </ext:TriggerField>
                                                <ext:TextField ID="txtAddPallet" runat="server" Width="120" ReadOnly="true" />
                                            </Items>
                                        </ext:FieldContainer>
                                    </Items>
                                </ext:Container>
