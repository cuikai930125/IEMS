<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BinStatusManager.aspx.cs" Inherits="Plugins_JHWMS_BinManager_BinStatusManager" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        var oncellover = function (e, data) {
            ...
            html = html + "物料名称：" + data.MATER_NAME + "<br\>";
            html = html + "工装编号：" + data.PalletNo + "<br\>";
            html = html + "生产日期：" + data.ProductDate + "<br\>";
            html = html + "入库日期：" + data.CreateDate + "<br\>";
                    ...
                    <Items>
                        <ext:Container runat="server" Layout="FormLayout" Padding="5" ColumnWidth="1">
                            <Items>
                                ...
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="可用状态" Name="UsedFlag" />
                                ...
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="托盘编号" Name="PalletNo" />
                                ...
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="归属设备" Name="CrnNo" />
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="生产日期" Name="ProductDate" />
                                <ext:TextField runat="server" ReadOnly="true" Flex="1" LabelAlign="Right" FieldLabel="入库日期" Name="CreateDate" />
                            </Items>
                        </ext:Container>
                    </Items>
                </ext:FormPanel>
