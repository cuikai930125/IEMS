...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:Panel ID="BorderPanelNorth" runat="server" Height="32" Region="North" Header="false"
        ...
        <div id="head_div" class='t' >
            <div class='h'>
                <div class='logo' >
                    <img alt="MESNAC.COM" src='<%= Page.ResolveUrl("./") %>resources/images/mesnac.png' />
                </div>
        ...
        <div id="foot_div" class='foot'>
           <%-- <div  style="width:0px; height:0px;">
            ...
            软控股份有限公司 &copy;<%= DateTime.Now.ToString("yyyy") %> 华晟(青岛)智能装备科技有限公司 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;V&nbsp;<%= Vision() %>&nbsp;&nbsp;&nbsp;&nbsp;
        </div>
    </form>
</body>
</html>
